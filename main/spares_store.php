...
مَخْزَن قطع الغيار 
		    ...
		    <div class="product_section_2 images">
			    <div class="row">
				<div class="col-sm-4">
			    		<div class="images"><a href="../sub/spares/"><img src="images/a1.jpg" title="الأصناف" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    
			    	<div class="col-sm-4">
			    		<div class="images"><a href="../sub/spares_suppliers"><img src="images/a5.jpg" title="المُوردين"  style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    		<div class="col-sm-4">
			    		<div class="images"><a href="../sub/spares_store"><img src="images/a2.jpg" title="حركة المخزن" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
                    	<div class="col-sm-4">
			    		<div class="images"><a href="external"><img src="images/a4.jpg" title="صيانة خا ؤجية" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
		   
			    	
			    	<div class="col-sm-4">
			    		<div class="images"><a href="../sub/spares_reports"><img src="images/a3.jpg" title="تقارير" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>

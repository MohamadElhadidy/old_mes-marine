        ...
        <div class="navs">
            <div class="container_nav">
                <div id="mainListDiv" class="main_list">
                    <ul class="navlinks">
                        <li><a href="reports"> <i class="fas fa-podcast" style="color: red"></i> الرئيسية </a></li>
                        <li><a href="javascript:{}" onclick="document.getElementById('the_form').submit(); return false;">تسجيل الخروج</a></li>
                    </ul>
                </div>
                <div class="logo">
                    <a href="reports">الشَركةُ البَحرية</a>
                </div>
...
مَخْزَن الزُّيُوت و الْوَقُود
		    ...
		    <div class="product_section_2 images">
			    <div class="row">
			    	<div class="col-sm-4">
			    		<div class="images"><a href="../sub/spares_reports"><img src="images/a32.jpg" title="مخزن قطع الغيار" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	<div class="col-sm-4">
			    		<div class="images"><a href="../sub/oils_reports"><img src="images/a33.jpg" title="مخزن الزيوت والوقود" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	
			     <div class="col-sm-4">
			    		<div class="images"><a href="../sub/reports/select_equip"><img src="images/41.jpg" title=" تقرير صيانة شامل" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>

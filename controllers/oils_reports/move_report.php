...
$query = "SELECT  *  FROM  oil_store_enter WHERE name = '".$_GET["id"]."' AND order_date BETWEEN '".$_POST["From"]."' AND '".$_POST["to"]."'    order by order_num DESC ";
...
$query = "SELECT  *  FROM  oil_store_out WHERE name = '".$_GET["id"]."'  AND order_date BETWEEN '".$_POST["From"]."' AND '".$_POST["to"]."'    order by order_num DESC ";

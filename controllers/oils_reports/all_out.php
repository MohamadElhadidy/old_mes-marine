...
$query3 = "SELECT  count(*) as count ,Sum(balance) as balance FROM  oil_store_out  WHERE
...
$query = "SELECT 
    *
FROM
   oil_store_out WHERE  is_delete = 0  AND order_date  BETWEEN '".$_POST["From"]."' AND '".$_POST["to"]."'  
...
while($row2= mysqli_fetch_array($sql2))
{
        $id = $row2['id'];
    $name = $row2['name'];
    $query2 = "SELECT  count(*) as count ,Sum(balance) as balance FROM  oil_store_out where type ='$id'   AND  order_date BETWEEN '".$_POST["From"]."' AND '".$_POST["to"]."'  ";

...
$query = "SELECT * FROM    spare_store_out  WHERE direction = '".$_GET["equip"]."'  AND tb = 'equipments'  
...
<td>'.$row["notes"].'</td>
 ...
 WHERE  direction = '".$_GET["equip"]."' AND tb = 'equipments'  AND order_date BETWEEN '".$_POST["From"]."' AND '".$_POST["to"]."' 
";

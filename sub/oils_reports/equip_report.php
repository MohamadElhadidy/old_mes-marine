...
<body>
<img src="../../assets/images/headers/reports/equip_oil-report.png" width="100%">
...
$result2 = mysqli_query($con,  "SELECT * FROM  oil_type WHERE id = '".$_GET["type"]."'");
...
SELECT 
    *
FROM
   oil_store_out  WHERE direction = '".$_GET["equip"]."' AND type = '".$_GET["type"]."' AND tb = 'equipments'  order by order_num DESC
";
...
<table style="margin-bottom:20px;">
    ...
    <td>نوع الصنف : <?php echo $row2["name"]; ?></td>
</table>    
...
<div id="purchase_order">
  <?php  $query2 = " SELECT SUM(price *balance) As sum,sum(balance) as qnt FROM oil_store_out   
 WHERE  direction = '".$_GET["equip"]."' AND
   type = '".$_GET["type"]."' AND tb = 'equipments' 
";
...
{
$.ajax({
url:"../../controllers/oils_reports/equip_report.php?equip=<?php echo $equip; ?>&type=<?php echo $type; ?>",
method:"POST",

...
<body>
<img src="../../assets/images/headers/oils_store/spare_limit-report.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/limit_report.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/oils_store/spare_limit-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6, 7]
                    },

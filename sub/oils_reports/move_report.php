...
<body>
<img src="../../assets/images/headers/oils_store/sapre_move-report.png" width="100%">


<?php

$items =array();
$row1 = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM oils WHERE id ='".$_GET['id']."'"));


$query = "SELECT  *  FROM  oil_store_enter WHERE name = '".$_GET["id"]."'  AND is_delete = 0 order by order_num DESC ";
...
$query = "SELECT  *  FROM  oil_store_out WHERE name = '".$_GET["id"]."'  AND is_delete = 0  order by order_num DESC ";
...
<?php
    ...
    if($item["tb"] == "other") $item["direction"] = 'أخرى';
        ...
        $order_type = "دخول";
        $row2 = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM oil_suppliers WHERE id ='".$item["supplier"]."'"));
...
{
$.ajax({
url:"../../controllers/oils_reports/move_report.php?id=<?php echo $_GET['id']; ?>",
method:"POST",

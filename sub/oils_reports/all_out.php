...
<body>
<img src="../../assets/images/headers/oils_store/203.png" width="100%">
...
$query = "SELECT *  FROM  oil_store_out  where is_delete = 0 order by order_date DESC,order_num DESC LIMIT  $offset,  $limit";
...
while($row2= mysqli_fetch_array($sql2))
{
    $id = $row2['id'];
    $name = $row2['name'];
    $query2 = "SELECT  count(*) as count ,Sum(balance) as balance FROM  oil_store_out where type ='$id' ";
...
<!--Bordered Pagination-->
  ...
  <?php
								...
								$sql2 = mysqli_query($con, "SELECT count(*) as count  FROM  oil_store_out  where is_delete = 0");
...
{
$.ajax({
url:"../../controllers/oils_reports/all_out.php",
method:"POST",

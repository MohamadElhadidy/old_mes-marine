...
<head>
    <title>             مخزن  الزُّيُوت و الْوَقُود  - تقرير الاصناف
...
<img src="../../assets/images/headers/spares_store/sp-report.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/oils_report.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/oils_store/sp-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    title:'',
                    exportOptions: {
                        columns: [0, 1, 2, 3]

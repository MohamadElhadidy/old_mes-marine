...
<!-- site metas -->
<title>مخزن  الزُّيُوت و الْوَقُود   - الأصناف</title>
...
الأصناف بالمخزن
		    ...
		    <div class="product_section_2 images">
			    <div class="row">
				<div class="col-sm-4">
			    		<div class="images"><a href="add"><img src="../../main/images/a20.jpg" title="إضافة صنف " style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	<div class="col-sm-4">
			    		<div class="images"><a href="report"><img src="../../main/images/a21.jpg" title="إجمالي الأصناف بالمخزن" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>

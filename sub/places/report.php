...
<img src="../../assets/images/headers/equipments/pl-report.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/places_report.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/equipments/pl-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    title:'',
                    exportOptions: {
                        columns: [0, 1, 2, 3]

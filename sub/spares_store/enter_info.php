...
$result = mysqli_query($con, "SELECT  * FROM spare_store_enter   WHERE  id = '$id' ");
...
$sum = mysqli_query($con, "SELECT SUM(price * balance) As sum,  count(*) as total  FROM spare_store_enter  WHERE  is_delete = 0  AND order_num = '$order_num'   ");
...
<body>
    <img src="../../assets/images/headers/spares_store/enter-report1.png" width="100%">
...
$result2 = mysqli_query($con, "SELECT  * FROM spare_store_enter   WHERE  is_delete = 0  AND order_num = '$order_num' ");

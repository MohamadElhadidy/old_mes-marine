...
<script>
	...
	<body>
		 <?php  $result2 = mysqli_query($con, "SELECT order_num FROM spare_store_out ORDER BY order_num DESC LIMIT 1");
  ...
  <form method='post' action='out'>
    ...
    <div class="inputbox">
			  ...
			  <select  id="type"  name="type"   style="width:100%;height:40px;"  required>
                    ...
                    <option value="safety"> مهمات وقائية</option>
                    <option value="tools"> عدد وادوات</option>

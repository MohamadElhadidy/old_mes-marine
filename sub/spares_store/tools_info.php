...
$sum = mysqli_query($con, "SELECT SUM(price * balance) As sum,  count(*) as total  FROM spare_store_out  WHERE  is_delete = 0 AND tb = 'tools'  AND order_num = '$order_num' ");
...
$result2 = mysqli_query($con, "SELECT  * FROM spare_store_out  WHERE  is_delete = 0  AND tb = 'tools'   AND order_num = '$order_num' ");

...
<!-- site metas -->
<title>مخزن قطع الغيار  - حركة المخزن</title>
...
حركة المخزن
		    ...
		    <div class="product_section_2 images">
			    <div class="row">
				<div class="col-sm-4">
			    		<div class="images"><a href="enter_number"><img src="../../main/images/a11.jpg" title=" إذن دخول / وارد جديد" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	<div class="col-sm-4">
			    		<div class="images"><a href="out_number"><img src="../../main/images/a12.jpg" title="إذن خروج / منصرف جديد" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	
			    <div class="col-sm-4">
			    		<div class="images"><a href="enter_report"><img src="../../main/images/a7.jpg" title="مستند دخول / وارد " style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	<div class="col-sm-4">
			    		<div class="images"><a href="out_report"><img src="../../main/images/a8.jpg" title="مستند خروج / مُنصرف" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
                    	<div class="col-sm-4">
			    		<div class="images"><a href="safety_report"><img src="../../main/images/a9.jpg" title="مستند  مهمات " style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
                    	<div class="col-sm-4">
			    		<div class="images"><a href="tools_report"><img src="../../main/images/a10.jpg" title="مستند  عدد و أدوات " style="max-width: 100%; width: 100%;"></a></div>
			    	</div>

...
<script>
	...
	<body>
		  <?php  $result2 = mysqli_query($con, "SELECT order_num FROM spare_store_enter ORDER BY order_num DESC LIMIT 1");
  ...
  <form method='post' action='enter'>
    ...
    <div class="inputbox">
			    ...
			    <?php
			    $query = "SELECT * FROM spare_suppliers where is_delete = 0";
    ...
    <div class="inputbox">
			  ...
			  <select  id="type"  name="type"   style="width:100%;height:40px;"  required>
               ...
               <?php
			    $query2 = "SELECT * FROM spare_types where is_delete = 0";

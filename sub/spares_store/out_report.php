...
<body>
    <img src="../../assets/images/headers/spares_store/out-report.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/spare_out_report.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/spares_store/out-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    },

...
<!-- site metas -->
<title>مخزن الزيوت والوقود - حركة المخزن</title>
           ...
           <div class="navs">
            <div class="container_nav">
                <div id="mainListDiv" class="main_list">
                    <ul class="navlinks">
                           <li><a href="../../main/oils_store"> <i class="fas fa-podcast" style="color: red"></i> الرئيسية </a></li>
                        <li><a href="javascript:{}" onclick="document.getElementById('the_form').submit(); return false;">تسجيل الخروج</a></li>
                    </ul>
                </div>
                <div class="logo">
                    <a href="../../main/oils_store">الشَركةُ البَحرية</a>
                </div>

...
//  require "../../controllers/oils_store/out.php";
if(isset($_POST['out_button'])){
	...
	$s = "insert into oil_store_out (order_num, order_date, tb, type, name, balance, price, direction,  recipient, employee, notes, date) values";
	...
	if(!mysqli_query($con, $s)){
		...
		for($i=0;$i<$_POST['numbers'];$i++)
		{
	     	mysqli_query($con,"update oils set balance = '$newBalance[$i]' where id = '".$_POST['name'][$i]."'");
		}
	       	echo "<script>

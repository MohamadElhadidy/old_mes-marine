...
<head>
    <title>            أذونات حركة الخروج من مخزن الوقود والزيوت 
</title>
...
<body>
    <img src="../../assets/images/headers/oils_store/out-report.png" width="100%">
        ...
        $('#table').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/oils_store/out-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    },

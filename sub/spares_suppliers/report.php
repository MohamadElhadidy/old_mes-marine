...
<body>
<img src="../../assets/images/headers/oils_store/spp-report.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/spares_suppliers.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/oils_store/spp-report.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    exportOptions: {
                        columns: [0, 1, 2]
                    },

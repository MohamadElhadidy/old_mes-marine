...
if (isset($_POST['add_button']))
{
    ...
    $notes = strip_tags($_POST['notes']);
	  $_SESSION['notes'] = $notes;
		...
		if(mysqli_num_rows(mysqli_query($con, "SELECT * FROM spare_suppliers WHERE code='$code'  ")) > 0) array_push($error_array, "herecode") ;
	  if(mysqli_num_rows(mysqli_query($con, "SELECT * FROM spare_suppliers WHERE  name = '$name' ")) > 0) array_push($error_array, "herename") ;

	if(empty($error_array))
	{
		$query =mysqli_query($con , "INSERT INTO spare_suppliers (code, name, notes) VALUES ('$code', '$name', '$notes')");
...
<head>
  <meta charset="utf-8">
  <title>إضافة مورد - مخزن قطع الغيار </title>
...
<div class="center">
  <h1>إضافة مورد - مخزن  قطع الغيار </h1>
  <form method='post'>
    <div class="inputbox">

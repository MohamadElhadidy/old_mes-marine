  ...
  {   
    ورش داخل الشركة
		    ...
		    <div class="product_section_2 images">
			    <div class="row">
				<div class="col-sm-4">
			    		<div class="images"><a href="add"><img src="../../main/images/a41.jpg" title="إضافة ورشة" style="max-width: 100%; width: 100%;"></a></div>
			    	</div>
			    	<div class="col-sm-4">
			    		<div class="images"><a href="report"><img src="../../main/images/a42.jpg" title=" تقرير بإجمالي الورش   " style="max-width: 100%; width: 100%;"></a></div>
			    	</div>

...
<img src="../../assets/images/headers/equipments/eq-report2.png" width="100%">
...
$(document).ready(function() {
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../../datatables/workshops_report.php',
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="../../assets/images/headers/equipments/eq-report2.png"  style="position:relative;width:100%;" />',
                    autoPrint: true,
                    title:'',
                    exportOptions: {
                        columns: [0, 1, 2, 3]

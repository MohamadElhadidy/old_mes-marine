...
$sel = "SELECT count(*) as allcount FROM spares  ";
...
$sel = "SELECT count(*) as allcount FROM spares where   1  ".$searchQuery."  ";
$Records2 = mysqli_query($con, $sel);
$records2 = mysqli_fetch_assoc($Records2);
$totalRecordwithFilter = $records2['allcount'] ;

## Fetch records


$empQuery = "SELECT * FROM spares where      1  ".$searchQuery."  order by code asc ".$columnName." ".$columnSortOrder."  ".$rowLength."" ; 

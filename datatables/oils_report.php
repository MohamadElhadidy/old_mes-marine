...
$sel = "SELECT count(*) as allcount FROM oils  ";
...
$sel = "SELECT count(*) as allcount FROM oils where   1  ".$searchQuery."  ";
...
$empQuery = "SELECT * FROM oils where      1  ".$searchQuery."  order by code asc ".$columnName." ".$columnSortOrder."  ".$rowLength."" ; 

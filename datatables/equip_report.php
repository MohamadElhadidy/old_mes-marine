...
$query = "SELECT * FROM oil_store_out 
        WHERE direction = '".$_GET["equip"]."'
        AND type = '".$_GET["type"]."'   AND tb = 'equipments' 
...
echo $result;
 ...
 $query2 = " SELECT SUM(price * balance) As sum,sum(balance) as qnt FROM oil_store_out   WHERE  direction = '".$_GET["equip"]."' AND

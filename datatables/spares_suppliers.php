...
$sel = "SELECT * FROM spare_suppliers    ";
...
$sel = "SELECT * FROM spare_suppliers    where   1  ".$searchQuery." ";
$Records = mysqli_query($con, $sel);
...
$empQuery = "SELECT * FROM spare_suppliers  where  1  ".$searchQuery." order by  code desc ".$columnName." ".$columnSortOrder."  ".$rowLength.""; 

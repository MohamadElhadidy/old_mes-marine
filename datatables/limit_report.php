...
$sel = "SELECT * FROM oils   where (lmit >= balance) ";
...
$sel = "SELECT * FROM oils    where   (lmit >= balance)  ".$searchQuery." ";
$Records = mysqli_query($con, $sel);
...
$empQuery = "SELECT * FROM oils where  (lmit >= balance)  ".$searchQuery." order by  balance desc ".$columnName." ".$columnSortOrder."  ".$rowLength.""; 

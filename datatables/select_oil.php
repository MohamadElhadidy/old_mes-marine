...
$sel = "SELECT * FROM oils    where   1  ".$searchQuery." ";
$Records = mysqli_query($con, $sel);
...
$empQuery = "SELECT * FROM oils where  1  ".$searchQuery." order by  balance desc ".$columnName." ".$columnSortOrder."  ".$rowLength.""; 

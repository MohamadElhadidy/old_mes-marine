...
$sel = "SELECT * FROM spares   where (lmit >= balance) ";
...
$sel = "SELECT * FROM spares    where   (lmit >= balance)  ".$searchQuery." ";
$Records = mysqli_query($con, $sel);
...
$empQuery = "SELECT * FROM spares where  (lmit >= balance)  ".$searchQuery." order by  balance desc ".$columnName." ".$columnSortOrder."  ".$rowLength.""; 
